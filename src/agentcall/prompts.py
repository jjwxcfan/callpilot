...
def _build_zh(
    ...
    common = (
        ...
        "选项（比如切换菜单语言）不要按，哪怕它是最先播报的；开头单独播的"
        "语言选择提示不是完整菜单，菜单没把本轮选项报完之前不要按任何键。"
...
def _build_en(
    ...
    common = (
        ...
        "is announced first; the standalone language prompt at the start is not "
        "the full menu — press nothing until the round has finished listing its "
        "options. "
